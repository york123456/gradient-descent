	...
	*/
	...
	for (i = 0; i < 300; i++) {
		...
		for (rrr = 0; rrr < 8; rrr++) {
			...
			String str2 = std::to_string(rand() % 50);
			char str3[] = ".png";
			String Str;
			Str.append(str);
			Str.append(str2);
			...
			Mat img;
			resize(img2, img, Size(8, 8), INTER_LINEAR);
			...
			String str2A = std::to_string(rand() % 50);
			char str3A[] = ".png";
			String StrA;
			StrA.append(strA);
			StrA.append(str2A);
			...
			Mat img4;
			resize(img3, img4, Size(8, 8), INTER_LINEAR);
			...
			String str2B = std::to_string(rand() % 50);
			char str3B[] = ".png";
			String StrB;
			StrB.append(strB);
			StrB.append(str2B);
			...
			Mat img6;
			resize(img5, img6, Size(8, 8), INTER_LINEAR);
			...
			String str2C = std::to_string(rand() % 50);
			char str3C[] = ".png";
			String StrC;
			StrC.append(strC);
			StrC.append(str2C);
			...
			Mat img8;
			resize(img7, img8, Size(8, 8), INTER_LINEAR);
	...
	*/
	...
	while (true)
	{
		...
		if (input == 8) {
			...
			Mat img10;
			resize(img9, img10, Size(8, 8), INTER_LINEAR);
		...
		if (input == 5) {
			...
			Mat img12;
			resize(img11, img12, Size(8, 8), INTER_LINEAR);
